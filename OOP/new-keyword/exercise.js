...
const test1 = new Person('Bob', "smith", 'blue', 10);

test1.multiplyFavoriteNumber(5);
...
// from the Parent function. You should be able to remove 4 lines of code in the 
// Child function and replace it with 1 single line.
